...

{
  ...
  users.users.root.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJfU4wRbxQ/XYyUrJfwJg/jwVSRHiu2k6JbqdPdbrtOi fabian@nixos"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAII7Yug7DCtO601W16pq3zC1f3EUudHpiv6FQk4By8pFZ handy"
  ];
  ...
  environment.systemPackages = with pkgs; [
    vim git lm_sensors speedtest-go
  ];
